...
export default function AppShell({ currentPage, onPageChange, children }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-finpath-white)] text-slate-900">
      <header className="no-print sticky top-0 z-40 border-b border-[var(--color-finpath-card)] bg-[var(--color-finpath-navy)] px-3 py-3 shadow-sm print:hidden sm:px-4 lg:hidden">
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex min-h-11 shrink-0 items-center gap-2 rounded-xl border border-[var(--color-finpath-teal)] px-3 py-2 text-sm font-semibold text-white hover:bg-[var(--color-finpath-card)]"
          >
              ...
              return (
                <button
                  ...
                  className={`flex min-h-11 w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-medium transition ${
                    active
                      ? 'bg-[var(--color-finpath-teal)] text-[var(--color-finpath-navy)]'
                      : 'text-white hover:bg-[var(--color-finpath-card)]'
                  }`}
                >
                  <Icon size={18} />
                  {item.label}
      ...
      <aside className="no-print fixed left-0 top-0 hidden h-screen w-72 border-r border-[var(--color-finpath-card)] bg-[var(--color-finpath-navy)] p-5 print:hidden lg:block">
        <div className="mb-8">
          <img
            src={brandLogo}
            alt="FinPath"
            ...
            return (
              <button
                ...
                className={`flex min-h-11 w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-medium transition ${
                  active
                    ? 'bg-[var(--color-finpath-teal)] text-[var(--color-finpath-navy)]'
                    : 'text-[var(--color-finpath-muted)] hover:bg-[var(--color-finpath-card)] hover:text-white'
                }`}
              >
                <Icon size={18} />
                {item.label}
